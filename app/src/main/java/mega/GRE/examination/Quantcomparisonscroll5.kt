...
class Quantcomparisonscroll5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.quantcomparisonscroll5)
        rg = findViewById(R.id.r5)
        tv1 = findViewById(R.id.textView112)
        tv2 = findViewById(R.id.textView113)
        tv3 = findViewById(R.id.textView114)
        btn = findViewById(R.id.button105)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            when (ids) {
                R.id.radioButton17 -> {
                    ...
                    sum = a + b
                    val send = Intent(this@Quantcomparisonscroll5, Quantcomparisonscroll6::class.java)
                ...
                R.id.radioButton18 -> {
                    ...
                    sum = a + b
                    val send1 = Intent(this@Quantcomparisonscroll5, Quantcomparisonscroll6::class.java)
                ...
                R.id.radioButton19 -> {
                    ...
                    sum = a + b
                    val send2 = Intent(this@Quantcomparisonscroll5, Quantcomparisonscroll6::class.java)
                ...
                R.id.radioButton20 -> {
                    ...
                    sum = a + b
                    val send8 = Intent(this@Quantcomparisonscroll5, Quantcomparisonscroll6::class.java)
            ...
            override fun run() {
                try {
                    ...
                    if (clicked) {
                        ...
                        val bol = Intent(this@Quantcomparisonscroll5, Times::class.java)
                        val v = 0
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Quantcomparisonscroll5)
        make.setTitle("SORRY !!")
