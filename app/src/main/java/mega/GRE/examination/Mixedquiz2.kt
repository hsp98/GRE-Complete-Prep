...
class Mixedquiz2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.mixedquiz2)
        rg = findViewById(R.id.r601)
        tv1 = findViewById(R.id.textView603)
        tv2 = findViewById(R.id.textView604)
        tv3 = findViewById(R.id.textView605)
        btn = findViewById(R.id.button601)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            when (ids) {
                R.id.radioButton604 -> {
                    ...
                    sum = a + b
                    val send = Intent(this@Mixedquiz2, Mixedquiz3::class.java)
                ...
                R.id.radioButton605 -> {
                    ...
                    sum = a + b
                    val send1 = Intent(this@Mixedquiz2, Mixedquiz3::class.java)
                ...
                R.id.radioButton606 -> {
                    ...
                    sum = a + b
                    val send2 = Intent(this@Mixedquiz2, Mixedquiz3::class.java)
                ...
                R.id.radioButton607 -> {
                    ...
                    sum = a + b
                    val send8 = Intent(this@Mixedquiz2, Mixedquiz3::class.java)
        ...
        rg?.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            if (R.id.radioButton604 == checkedId) {
                value = 0
            } else if (R.id.radioButton605 == checkedId) {
                value1 = 0
            } else if (R.id.radioButton606 == checkedId) {
                value2 = 1
            } else if (R.id.radioButton607 == checkedId) {
                value3 = 0
            }
        })
            ...
            override fun run() {
                try {
                    ...
                    if (clicked) {
                        ...
                        val bol = Intent(this@Mixedquiz2, Times::class.java)
                        val v = 0
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Mixedquiz2)
        make.setTitle("SORRY !!")
