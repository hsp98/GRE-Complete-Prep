...
class Quantnumericscroll3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.quantnumericscroll3)
        et = findViewById(R.id.edittext142)
        btn = findViewById(R.id.button142)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            if (answer == 6) {
                ...
                b = 1
                sum = a + b
                val i = Intent(this@Quantnumericscroll3, Quantnumericscroll4::class.java)
                i.putExtra("val3", sum)
                startActivity(i)
                finish()
            } else {
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Quantnumericscroll3)
        make.setTitle("SORRY !!")
