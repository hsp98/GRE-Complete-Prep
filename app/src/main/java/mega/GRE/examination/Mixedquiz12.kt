...
class Mixedquiz12 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.mixedquiz12)
        rg = findViewById(R.id.r608)
        tv1 = findViewById(R.id.textView619)
        btn = findViewById(R.id.button610)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            when (ids) {
                R.id.radioButton632 -> {
                    ...
                    inte = intent
                    a = inte?.getIntExtra("val11", 0)!!
                    b = num.calculatescore1(value)
                    sum = a + b
                    val send = Intent(this@Mixedquiz12, Mixedquiz13::class.java)
                ...
                R.id.radioButton633 -> {
                    ...
                    sum = a + b
                    val send1 = Intent(this@Mixedquiz12, Mixedquiz13::class.java)
                ...
                R.id.radioButton634 -> {
                    ...
                    sum = a + b
                    val send2 = Intent(this@Mixedquiz12, Mixedquiz13::class.java)
                ...
                R.id.radioButton635 -> {
                    ...
                    sum = a + b
                    val send8 = Intent(this@Mixedquiz12, Mixedquiz13::class.java)
        ...
        rg?.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            if (R.id.radioButton632 == checkedId) {
                value = 1
            } else if (R.id.radioButton633 == checkedId) {
                value1 = 0
            } else if (R.id.radioButton634 == checkedId) {
                value2 = 0
            } else if (R.id.radioButton635 == checkedId) {
                value3 = 0
            }
        })
            ...
            override fun run() {
                try {
                    ...
                    if (clicked) {
                        ...
                        val bol = Intent(this@Mixedquiz12, Times::class.java)
                        val v = 0
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Mixedquiz12)
        make.setTitle("SORRY !!")
