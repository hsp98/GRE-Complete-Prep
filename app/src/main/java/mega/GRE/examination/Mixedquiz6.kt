...
class Mixedquiz6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.mixedquiz6)
        et = findViewById(R.id.edittext613)
        btn = findViewById(R.id.button605)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            if (answer == 2550) {
                ...
                b = 1
                sum = a + b
                val i = Intent(this@Mixedquiz6, Mixedquiz7::class.java)
                i.putExtra("val6", sum)
                startActivity(i)
                finish()
            } else {
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Mixedquiz6)
        make.setTitle("SORRY !!")
