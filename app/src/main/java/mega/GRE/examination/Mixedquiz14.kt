...
class Mixedquiz14 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.mixedquiz14)
        rg = findViewById(R.id.r610)
        tv1 = findViewById(R.id.textView621)
        btn = findViewById(R.id.button612)
        btn?.setOnClickListener(View.OnClickListener {
            ...
            when (ids) {
                R.id.radioButton640 -> {
                    ...
                    inte = intent
                    a = inte?.getIntExtra("val13", 0)!!
                    b = num.calculatescore1(value)
                    sum = a + b
                    val send = Intent(this@Mixedquiz14, Mixedquiz15::class.java)
                ...
                R.id.radioButton641 -> {
                    ...
                    sum = a + b
                    val send1 = Intent(this@Mixedquiz14, Mixedquiz15::class.java)
                ...
                R.id.radioButton642 -> {
                    ...
                    sum = a + b
                    val send2 = Intent(this@Mixedquiz14, Mixedquiz15::class.java)
                ...
                R.id.radioButton643 -> {
                    ...
                    sum = a + b
                    val send8 = Intent(this@Mixedquiz14, Mixedquiz15::class.java)
        ...
        rg?.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            if (R.id.radioButton640 == checkedId) {
                value = 0
            } else if (R.id.radioButton641 == checkedId) {
                value1 = 0
            } else if (R.id.radioButton642 == checkedId) {
                value2 = 1
            } else if (R.id.radioButton643 == checkedId) {
                value3 = 0
            }
        })
            ...
            override fun run() {
                try {
                    ...
                    if (clicked) {
                        ...
                        val bol = Intent(this@Mixedquiz14, Times::class.java)
                        val v = 0
    ...
    protected fun exitByBackKey() {
        val make = AlertDialog.Builder(this@Mixedquiz14)
        make.setTitle("SORRY !!")
